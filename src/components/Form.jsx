...
function Form () {
  ...
  const [isLoadingGeoPostion, setIsLoadingGeoPosition] = useState(false)
  ...
  useEffect(function(){
    ...
    async function FetchCityData(){
      ...
      if(!data.countryCode) throw new Error("This doesn't seem like a city, click somewhere else")
      console.log(data)
  ...
  if (isLoadingGeoPostion) return <Spinner />
